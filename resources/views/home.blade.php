          ...
          <div class="container">
               ...
               <div class="collapse navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                         <li><a href="#">Hubungi Sekarang! <i class="fa fa-phone"></i> 010 020 0340</a></li>
                    ...
                    <div class="owl-carousel owl-theme">
                              ...
                              <div class="caption">
                                   <div class="container">
                                        <div class="col-md-8 col-sm-12">
                                             <h3>Catering &amp; Restaurant</h3>
                                             <h1>Misi kami adalah memberikan pengalaman yang tak terlupakan</h1>
                                             <a href="#team" class="section-btn btn btn-default smoothScroll"> Temui koki kami</a>
                                        </div>
                                   </div>
                              </div>
                         </div>
                         ...
                         <div class="item item-second">
                              <div class="caption">
                                   <div class="container">
                                        <div class="col-md-8 col-sm-12">
                                             <h3>Sarapan Sempurna Anda</h3>
                                             <h1>Kualitas santapan terbaik juga bisa ada di sini!</h1>
                                             <a href="#menu" class="section-btn btn btn-default smoothScroll">Temukan menu</a>
                                        </div>
                                   </div>
                              </div>
                         </div>
                         ...
                         <div class="item item-third">
                              <div class="caption">
                                   <div class="container">
                                        <div class="col-md-8 col-sm-12">
                                             <h3>Restoran Baru di Kota</h3>
                                             <h1>Nikmati menu spesial kami setiap hari Minggu dan Jumat</h1>
                                             <a href="#contact" class="section-btn btn btn-default smoothScroll">Reservasi</a>
                                        </div>
                                   </div>
                              </div>
                         </div>
                    ...
                    <div class="col-md-6 col-sm-12">
                         <div class="about-info">
                              <div class="section-title wow fadeInUp" data-wow-delay="0.2s">
                                   ...
                                   <h2>Kami Telah Membuat Makanan Lezat Sejak 1999</h2>
                              </div>
